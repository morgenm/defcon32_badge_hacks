...
#include "pio/pioIrdaSIR.h"
#include "display/dispDefcon.h"
#include "pio/pioWS2812.h"
#include "frontend.h"
#include "timebase.h"
#include "settings.h"
#include "pio/pioI2C.h"
#include "gameboy/gbCore.h"
#include "memMap.h"
...
static void uiPrvSelfTestsIfNeeded(void)
{
	...
	iobank0_hw->io[magicGpio].ctrl = (iobank0_hw->io[magicGpio].ctrl &~ IO_BANK0_GPIO0_CTRL_FUNCSEL_BITS) | (IO_BANK0_GPIO0_CTRL_FUNCSEL_VALUE_SIOB_PROC_0 << IO_BANK0_GPIO0_CTRL_FUNCSEL_LSB);
	...
	if (doSelfTest) {
		...
		iobank0_hw->io[PIN_IRDA_IN].ctrl = (iobank0_hw->io[PIN_IRDA_IN].ctrl &~ IO_BANK0_GPIO0_CTRL_FUNCSEL_BITS) | (IO_BANK0_GPIO0_CTRL_FUNCSEL_VALUE_SIOB_PROC_0 << IO_BANK0_GPIO0_CTRL_FUNCSEL_LSB);
		iobank0_hw->io[PIN_IRDA_OUT].ctrl = (iobank0_hw->io[PIN_IRDA_OUT].ctrl &~ IO_BANK0_GPIO0_CTRL_FUNCSEL_BITS) | (IO_BANK0_GPIO0_CTRL_FUNCSEL_VALUE_SIOB_PROC_0 << IO_BANK0_GPIO0_CTRL_FUNCSEL_LSB);
		iobank0_hw->io[PIN_IRDA_SD].ctrl = (iobank0_hw->io[PIN_IRDA_SD].ctrl &~ IO_BANK0_GPIO0_CTRL_FUNCSEL_BITS) | (IO_BANK0_GPIO0_CTRL_FUNCSEL_VALUE_SIOB_PROC_0 << IO_BANK0_GPIO0_CTRL_FUNCSEL_LSB);

		//set up bootsel pin as input...i hear you, the index here should be 5...but it is 1...do not ask
		ioqspi_hw->io[1].ctrl = (ioqspi_hw->io[1].ctrl &~ IO_BANK0_GPIO0_CTRL_FUNCSEL_BITS) | (IO_QSPI_GPIO_QSPI_SCLK_CTRL_FUNCSEL_VALUE_SIOB_PROC_58 << IO_BANK0_GPIO0_CTRL_FUNCSEL_LSB);
