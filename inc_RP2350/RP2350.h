 ...
 * @version  0.1
 * @date     Thu Jun 15 10:36:11 2023
 * @note     Generated by SVDConv V3.3.45
 *           from File '/home/graham/dev/amy/amy-sdk/src/foo/../rp2350/hardware_regs/rp2350.svd',
 *           last modified on Thu Jun  1 14:01:34 2023
 */
...
/* ===========================================  RP2350 Specific Interrupt Numbers  =========================================== */
  ...
  DMA_IRQ_2_IRQn            =  12,              /*!< 10 DMA_IRQ_2                                                              */
  DMA_IRQ_3_IRQn            =  13,              /*!< 11 DMA_IRQ_3                                                              */
  ...
  SPAREIRQ_IRQ_0_IRQn       =  46,              /*!< 46 SPAREIRQ_IRQ_0                                                         */
  SPAREIRQ_IRQ_1_IRQn       =  47,              /*!< 47 SPAREIRQ_IRQ_1                                                         */
  SPAREIRQ_IRQ_2_IRQn       =  48,              /*!< 48 SPAREIRQ_IRQ_2                                                         */
  SPAREIRQ_IRQ_3_IRQn       =  49,              /*!< 49 SPAREIRQ_IRQ_3                                                         */
  SPAREIRQ_IRQ_4_IRQn       =  50,              /*!< 50 SPAREIRQ_IRQ_4                                                         */
  SPAREIRQ_IRQ_5_IRQn       =  51,              /*!< 51 SPAREIRQ_IRQ_5                                                         */
} IRQn_Type;
...
typedef struct {                                /*!< SYSCFG Structure                                                          */
  ...
  __IOM uint32_t  PROC_IN_SYNC_BYPASS_HI;       /*!< For each bit, if 1, bypass the input synchronizer between that
                                                     ...
                                                     If you're feeling brave, you can bypass to save two cycles
                                                     of input
                                                     latency. This register applies to GPIO 32...47. USB GPIO
                                                     56..57 QSPI GPIO 58..63                                                   */
  __IOM uint32_t  DBGFORCE;                     /*!< Directly control the chip SWD debug port                                  */
  __IOM uint32_t  MEMPOWERDOWN;                 /*!< Control PD pins to memories.
                                                     Set high to put memories to a low power state. In this
                                                     state the memories will retain contents but not be accessible
                                                     Use with caution                                                          */
  __IOM uint32_t  SPARE;                        /*!< Spare registers, Just in case.                                            */
...
typedef struct {                                /*!< IO_BANK0 Structure                                                        */
  ...
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_SECURE0; /*!< IRQSUMMARY_COMA_WAKE_SECURE0                                              */
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_SECURE1; /*!< IRQSUMMARY_COMA_WAKE_SECURE1                                              */
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_NONSECURE0;/*!< IRQSUMMARY_COMA_WAKE_NONSECURE0                                         */
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_NONSECURE1;/*!< IRQSUMMARY_COMA_WAKE_NONSECURE1                                         */
...
typedef struct {                                /*!< IO_QSPI Structure                                                         */
  ...
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_SECURE;  /*!< IRQSUMMARY_COMA_WAKE_SECURE                                               */
  __IOM uint32_t  IRQSUMMARY_COMA_WAKE_NONSECURE;/*!< IRQSUMMARY_COMA_WAKE_NONSECURE                                           */
  __IOM uint32_t  INTR;                         /*!< Raw Interrupts                                                            */
...
typedef struct {                                /*!< XOSC Structure                                                            */
  ...
  __IOM uint32_t  COUNT;                        /*!< A down counter running at the xosc frequency which counts to
                                                     ...
                                                     sensitive hardware.
                                                     To start the counter, write a non-zero value. Reads will
                                                     return 1 while the count is running and 0 when it has finished.
                                                     Minimum count value is 4. Count values <4 will be treated
                                                     as count value =4.
...
/**
  * @brief Hardware access control registers (ACCESSCTRL_APBS)
  */

typedef struct {                                /*!< ACCESSCTRL_APBS Structure                                                 */
  __IOM uint32_t  LOCK;                         /*!< Once a LOCK bit is written to 1, ACCESSCTRL silently ignores
                                                     ...
                                                     LOCK bits are only writable when their value is zero. Once
                                                     set, they can never be cleared, except by a full reset
                                                     of ACCESSCTRL
                                                     
                                                     Setting the LOCK bit does not affect whether an access
                                                     raises a bus error. Unprivileged writes, or writes from
                                                     the DMA, will continue to raise bus errors. All other accesses
                                                     will continue not to.                                                     */
  __IOM uint32_t  FORCE_CORE_NS;                /*!< Force core 1's bus accesses to always be NonSecure, no matter
                                                     ...
                                                     registers internally based on security state but not on
                                                     master ID.                                                                */
  __IOM uint32_t  CFGRESET;                     /*!< Write 1 to reset all ACCESSCTRL configuration, except for the
                                                     ...
                                                     Note that, like all registers in ACCESSCTRL, this register
                                                     is not writable when the writer's corresponding LOCK bit
                                                     is set, therefore a master which has been locked out of
                                                     ACCESSCTRL can not use the CFGRESET register to disturb
                                                     its contents.                                                             */
  __IOM uint32_t  GPIO_NSMASK0;                 /*!< Control whether GPIO0...31 are accessible to NonSecure code.
                                                     Writable only by a Secure, Privileged processor or debugger.
                                                     
                                                     0 -> Secure access only
                                                     
                                                     1 -> Secure + NonSecure access                                            */
  __IOM uint32_t  GPIO_NSMASK1;                 /*!< Control whether GPIO32..47 are accessible to NonSecure code,
                                                     and whether QSPI and USB bitbang are accessible through
                                                     the NonSecure SIO. Writable only by a Secure, Privileged
  ...
  __IOM uint32_t  ROM;                          /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ...
                                                     which becomes NonSecure-Privileged-writable when the NSP
                                                     bit is set.                                                               */
  ...
  __IOM uint32_t  SYSCFG;                       /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ...
                                                     which becomes NonSecure-Privileged-writable when the NSP
                                                     bit is set.                                                               */
  __IOM uint32_t  CLOCKS_BANK_DEFAULT;          /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     CLOCKS_BANK_DEFAULT, and at what security/privilege levels
                                                     they can do so.
  ...
  __IOM uint32_t  XIP_AUX;                      /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ...
                                                     which becomes NonSecure-Privileged-writable when the NSP
                                                     bit is set.                                                               */
} ACCESSCTRL_APBS_Type;                         /*!< Size = 236 (0xec)                                                         */
...
typedef struct {                                /*!< PWM Structure                                                             */
  ...
  __IOM uint32_t  CH8_DIV;                      /*!< INT and FRAC form a fixed-point fractional number.
                                                     Counting rate is system clock frequency divided by this
                                                     number.
                                                     Fractional division uses simple 1st-order sigma-delta.                    */
  ...
  __IOM uint32_t  CH9_DIV;                      /*!< INT and FRAC form a fixed-point fractional number.
                                                     Counting rate is system clock frequency divided by this
                                                     number.
                                                     Fractional division uses simple 1st-order sigma-delta.                    */
  ...
  __IOM uint32_t  CH10_DIV;                     /*!< INT and FRAC form a fixed-point fractional number.
                                                     Counting rate is system clock frequency divided by this
                                                     number.
                                                     Fractional division uses simple 1st-order sigma-delta.                    */
  ...
  __IOM uint32_t  CH11_DIV;                     /*!< INT and FRAC form a fixed-point fractional number.
                                                     Counting rate is system clock frequency divided by this
                                                     number.
                                                     Fractional division uses simple 1st-order sigma-delta.                    */
...
/**
  * @brief Controls time and alarms\n
        ...
        The timer can be locked to prevent writing (TIMER0)
  */
...
typedef struct {                                /*!< TIMER0 Structure                                                          */
  ...
  __IOM uint32_t  LOCKED;                       /*!< Set locked bit to disable write access to timer
...
typedef struct {                                /*!< XIP_CTRL Structure                                                        */
  __IOM uint32_t  CTRL;                         /*!< Cache control register. Read-only from a NonSecure context.               */
  __IM  uint32_t  RESERVED;
...
/**
  * @brief QSPI Memory Interface.\n\n
        Provides a memory-mapped interface to up to two SPI/DSPI/QSPI flash or PSRAM devices. Also provides a serial interface for programming and configuration of the external device. (XIP_QMI)
  */

typedef struct {                                /*!< XIP_QMI Structure                                                         */
  __IOM uint32_t  DIRECT_CSR;                   /*!< Control and status for direct serial mode
                                                     
                                                     Direct serial mode allows the processor to send and receive
                                                     raw serial frames, for programming, configuration and control
                                                     of the external memory devices. Only SPI mode 0 (CPOL=0
                                                     CPHA=0) is supported.                                                     */
  ...
  __IOM uint32_t  M0_RFMT;                      /*!< Read transfer format configuration for memory address window
                                                     ...
                                                     configuration.                                                            */
  __IOM uint32_t  M0_RCMD;                      /*!< Read command constants for memory address window 0.
  ...
  __IOM uint32_t  M0_WFMT;                      /*!< Write transfer format configuration for memory address window
                                                     ...
                                                     support a basic 02h serial write transfer. However, writes
                                                     to this window must first be enabled via the XIP_CTRL_WRITABLE_M0
                                                     bit, as XIP memory is read-only by default.                               */
  __IOM uint32_t  M0_WCMD;                      /*!< Write command constants for memory address window 0.
  ...
  __IOM uint32_t  M1_RFMT;                      /*!< Read transfer format configuration for memory address window
                                                     ...
                                                     support a basic 03h serial read transfer with no additional
                                                     configuration.                                                            */
  __IOM uint32_t  M1_RCMD;                      /*!< Read command constants for memory address window 1.
  ...
  __IOM uint32_t  M1_WFMT;                      /*!< Write transfer format configuration for memory address window
                                                     ...
                                                     support a basic 02h serial write transfer. However, writes
                                                     to this window must first be enabled via the XIP_CTRL_WRITABLE_M1
                                                     bit, as XIP memory is read-only by default.                               */
  __IOM uint32_t  M1_WCMD;                      /*!< Write command constants for memory address window 1.
  ...
  __IOM uint32_t  ATRANS0;                      /*!< Configure address translation for XIP virtual addresses 0x000000
                                                     ...
                                                     without the overhead of position-independent code.
                                                     
                                                     At reset, the address translation registers are initialised
                                                     to an identity mapping, so that they can be ignored if
...
typedef struct {                                /*!< TRNG Structure                                                            */
  ...
  __IM  uint32_t  EHR_DATA0;                    /*!< RNG collected bits.
                                                     Bits [31:0] of Entropy Holding Register (EHR) - RNG output
                                                     register                                                                  */
  __IM  uint32_t  EHR_DATA1;                    /*!< RNG collected bits.
                                                     Bits [63:32] of Entropy Holding Register (EHR) - RNG output
                                                     register                                                                  */
  __IM  uint32_t  EHR_DATA2;                    /*!< RNG collected bits.
                                                     Bits [95:64] of Entropy Holding Register (EHR) - RNG output
                                                     register                                                                  */
  __IM  uint32_t  EHR_DATA3;                    /*!< RNG collected bits.
                                                     Bits [127:96] of Entropy Holding Register (EHR) - RNG output
                                                     register                                                                  */
  __IM  uint32_t  EHR_DATA4;                    /*!< RNG collected bits.
                                                     Bits [159:128] of Entropy Holding Register (EHR) - RNG
                                                     output register                                                           */
  __IM  uint32_t  EHR_DATA5;                    /*!< RNG collected bits.
                                                     Bits [191:160] of Entropy Holding Register (EHR) - RNG
                                                     output register                                                           */
...
typedef struct {                                /*!< SHA256 Structure                                                          */
  ...
  __OM  uint32_t  WDATA;                        /*!< Write data register
                                                     ...
                                                     After this, WDATA_RDY will return high, and more data can
                                                     be written (if any).
                                                     
                                                     This register supports word, halfword and byte writes,
                                                     so that DMA from non-word-aligned buffers can be supported.
                                                     The total amount of data per block remains the same (16
                                                     words, 32 halfwords or 64 bytes) and byte/halfword transfers
                                                     must not be mixed within a block.                                         */
  __IM  uint32_t  SUM0;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM1;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM2;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM3;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM4;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM5;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM6;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
  __IM  uint32_t  SUM7;                         /*!< 256-bit checksum result. Contents are undefined when CSR_SUM_VLD
                                                     is 0.                                                                     */
...
typedef struct {                                /*!< POWMAN Structure                                                          */
  ...
  __IOM uint32_t  LPOSC;                        /*!< low power oscillator control                                              */
  __IOM uint32_t  CHIP_RESET;                   /*!< Chip reset control and status                                             */
  __IOM uint32_t  WATCHDOG;                     /*!< Allows a watchdog reset to reset powman
                                                     This is intended for hardware debug and is of limited use
                                                     to the user.                                                              */
  __IOM uint32_t  SEQ_CFG;                      /*!< For configuration of the power sequencer
  ...
  __IOM uint32_t  STATE;                        /*!< This register controls the power state of the 4 power domains.
                                                     ...
                                                     flag is set while the Power Manager determines what is
                                                     required. If an invalid transition is requested the Power
                                                     Manager will still register the request in POWMAN_STATE_REQ
                                                     but will also set the POWMAN_BAD_REQ flag. It will then
                                                     implement the power-up requests and ignore the power down
                                                     requests. To do nothing would risk entering an unrecoverable
                                                     lock-up state. Invalid requests are: any combination of
                                                     power up and power down requests any request that results
                                                     in swcore boing powered and xip unpowered If the request
                                                     is to power down the switched-core domain then POWMAN_STATE_WAITING
                                                     stays active until the processors halt. During this time
                                                     the POWMAN_STATE_REQ field can be re-written to change
                                                     or cancel the request. When the power state transition
                                                     begins the POWMAN_STATE_WAITING_flag is cleared, the POWMAN_STATE_CHANGIN
                                                     flag is set and POWMAN register writes are ignored until
  ...
  __IOM uint32_t  LPOSC_FREQ_KHZ_INT;           /*!< LPOSC_FREQ_KHZ_INT                                                        */
  __IOM uint32_t  LPOSC_FREQ_KHZ_FRAC;          /*!< LPOSC_FREQ_KHZ_FRAC                                                       */
  __IOM uint32_t  XOSC_FREQ_KHZ_INT;            /*!< XOSC_FREQ_KHZ_INT                                                         */
  __IOM uint32_t  XOSC_FREQ_KHZ_FRAC;           /*!< XOSC_FREQ_KHZ_FRAC                                                        */
  ...
  __IM  uint32_t  READ_TIME_UPPER;              /*!< For reading bits 63:32 of the timer.                                      */
  __IM  uint32_t  READ_TIME_LOWER;              /*!< For reading bits 31:0 of the timer.                                       */
  ...
  __IOM uint32_t  PWRUP3;                       /*!< 4 GPIO powerup events can be configured to wake the chip up
                                                     ...
                                                     level = 0 triggers the pwrup when the source is low
                                                     level = 1 triggers the pwrup when the source is high                      */
  __IOM uint32_t  CURRENT_PWRUP_REQ;            /*!< Indicates current powerup request state
                                                     pwrup events can be cleared by removing the enable from
                                                     the pwrup register. The alarm pwrup req can be cleared
                                                     by clearing timer.alarm_enab
  ...
  __IOM uint32_t  BOOTDIS;                      /*!< Tell the bootrom to ignore the BOOT0..3 registers following
                                                     ...
                                                     unlock the pages by powering the core up and down.
                                                     
                                                     This register can be used to ensure that the bootloader
...
typedef struct {                                /*!< OTP Structure                                                             */
  __IOM uint32_t  SW_LOCK0;                     /*!< Software lock register for page 0.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK1;                     /*!< Software lock register for page 1.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK2;                     /*!< Software lock register for page 2.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK3;                     /*!< Software lock register for page 3.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK4;                     /*!< Software lock register for page 4.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK5;                     /*!< Software lock register for page 5.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK6;                     /*!< Software lock register for page 6.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK7;                     /*!< Software lock register for page 7.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK8;                     /*!< Software lock register for page 8.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK9;                     /*!< Software lock register for page 9.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK10;                    /*!< Software lock register for page 10.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK11;                    /*!< Software lock register for page 11.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK12;                    /*!< Software lock register for page 12.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK13;                    /*!< Software lock register for page 13.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK14;                    /*!< Software lock register for page 14.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK15;                    /*!< Software lock register for page 15.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK16;                    /*!< Software lock register for page 16.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK17;                    /*!< Software lock register for page 17.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK18;                    /*!< Software lock register for page 18.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK19;                    /*!< Software lock register for page 19.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK20;                    /*!< Software lock register for page 20.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK21;                    /*!< Software lock register for page 21.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK22;                    /*!< Software lock register for page 22.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK23;                    /*!< Software lock register for page 23.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK24;                    /*!< Software lock register for page 24.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK25;                    /*!< Software lock register for page 25.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK26;                    /*!< Software lock register for page 26.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK27;                    /*!< Software lock register for page 27.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK28;                    /*!< Software lock register for page 28.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK29;                    /*!< Software lock register for page 29.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK30;                    /*!< Software lock register for page 30.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK31;                    /*!< Software lock register for page 31.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK32;                    /*!< Software lock register for page 32.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK33;                    /*!< Software lock register for page 33.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK34;                    /*!< Software lock register for page 34.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK35;                    /*!< Software lock register for page 35.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK36;                    /*!< Software lock register for page 36.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK37;                    /*!< Software lock register for page 37.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK38;                    /*!< Software lock register for page 38.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK39;                    /*!< Software lock register for page 39.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK40;                    /*!< Software lock register for page 40.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK41;                    /*!< Software lock register for page 41.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK42;                    /*!< Software lock register for page 42.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK43;                    /*!< Software lock register for page 43.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK44;                    /*!< Software lock register for page 44.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK45;                    /*!< Software lock register for page 45.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK46;                    /*!< Software lock register for page 46.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK47;                    /*!< Software lock register for page 47.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK48;                    /*!< Software lock register for page 48.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK49;                    /*!< Software lock register for page 49.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK50;                    /*!< Software lock register for page 50.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK51;                    /*!< Software lock register for page 51.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK52;                    /*!< Software lock register for page 52.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK53;                    /*!< Software lock register for page 53.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK54;                    /*!< Software lock register for page 54.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK55;                    /*!< Software lock register for page 55.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK56;                    /*!< Software lock register for page 56.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK57;                    /*!< Software lock register for page 57.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK58;                    /*!< Software lock register for page 58.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK59;                    /*!< Software lock register for page 59.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK60;                    /*!< Software lock register for page 60.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK61;                    /*!< Software lock register for page 61.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK62;                    /*!< Software lock register for page 62.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SW_LOCK63;                    /*!< Software lock register for page 63.
                                                     
                                                     Locks are initialised from the OTP lock pages at reset.
                                                     This register can be written to further advance the lock
                                                     state of each page (until next reset), and read to check
                                                     the current lock state of a page.                                         */
  __IOM uint32_t  SBPI_INSTR;                   /*!< Instructions to the SBPI interface                                        */
  __IOM uint32_t  SBPI_WDATA_0;                 /*!< Write payload bytes 3..0                                                  */
  __IOM uint32_t  SBPI_WDATA_1;                 /*!< Write payload bytes 7..4                                                  */
  __IOM uint32_t  SBPI_WDATA_2;                 /*!< Write payload bytes 11..8                                                 */
  __IOM uint32_t  SBPI_WDATA_3;                 /*!< Write payload bytes 15..12                                                */
  __IM  uint32_t  SBPI_RDATA_0;                 /*!< Read payload bytes 3..0. Once read, the data in the register
                                                     will autoclear                                                            */
  __IM  uint32_t  SBPI_RDATA_1;                 /*!< Read payload bytes 7..4. Once read, the data in the register
                                                     will autoclear                                                            */
  __IM  uint32_t  SBPI_RDATA_2;                 /*!< Read payload bytes 11..8. Once read, the data in the register
                                                     will autoclear                                                            */
  __IM  uint32_t  SBPI_RDATA_3;                 /*!< Read payload bytes 15..12. Once read, the data in the register
                                                     will autoclear                                                            */
  __IOM uint32_t  SBPI_STATUS;                  /*!< SBPI_STATUS                                                               */
  __IOM uint32_t  USR;                          /*!< User interface                                                            */
  __IOM uint32_t  DBG;                          /*!< Debug                                                                     */
  __IOM uint32_t  PROD0_CTL;                    /*!< Controls availale only during production_mode = 0                         */
  __IOM uint32_t  BIST;                         /*!< During BIST, count address locations that have at least one
                                                     leaky bit                                                                 */
  __OM  uint32_t  CRT_KEY_W0;                   /*!< Word 0 (bits 31..0) of the key. Write only, read returns 0x0              */
  __OM  uint32_t  CRT_KEY_W1;                   /*!< Word 1 (bits 63..32) of the key. Write only, read returns 0x0             */
  __OM  uint32_t  CRT_KEY_W2;                   /*!< Word 2 (bits 95..64) of the key. Write only, read returns 0x0             */
  __OM  uint32_t  CRT_KEY_W3;                   /*!< Word 3 (bits 127..96) of the key. Write only, read returns 0x0            */
  ...
  __IOM uint32_t  DEBUGEN;                      /*!< Enable a debug feature that has been disabled. Debug features
                                                     ...
                                                     key value has not been supplied over SWD.
                                                     ...
                                                     are disabled. This can be fully overridden by setting all
                                                     ...
                                                     processor debug is disabled. This can be fully overridden
                                                     by setting the PROC0_SECURE and PROC1_SECURE bits of this
                                                     register.
                                                     
                                                     - If both debug keys have been registered, and the Secure
                                                     key's value (key 5) has been supplied over SWD, then no
                                                     debug features are disabled by the key mechanism. However,
                                                     note that in this case debug features may still be disabled
                                                     by the critical boot flags.                                               */
  ...
  __IOM uint32_t  ARCHSEL;                      /*!< Architecture select (Arm/RISC-V). The default and allowable
                                                     ...
                                                     Cores sample their architecture select signal on a warm
                                                     reset. The source of the warm reset could be the system
                                                     power-up state machine, the watchdog timer, Arm SYSRESETREQ
                                                     or from RISC-V hartresetreq.
                                                     
                                                     Note that when an Arm core is deselected, its cold reset
                                                     domain is also held in reset, since in particular the SYSRESETREQ
                                                     bit becomes inaccessible once the core is deselected. Note
  ...
  __IOM uint32_t  BOOTDIS;                      /*!< Tell the bootrom to ignore scratch register boot vectors (both
                                                     ...
                                                     order to protect their contents from later stages, there
                                                     is a risk that Secure code running at a later stage can
                                                     unlock the pages by performing a watchdog reset that resets
                                                     the OTP.
...
typedef struct {                                /*!< GLITCH_DETECTOR Structure                                                 */
  ...
  __IOM uint32_t  TRIG_STATUS;                  /*!< Set when a detector output triggers. Write-1-clear.
  ...
  __IOM uint32_t  TRIG_FORCE;                   /*!< Simulate the firing of one or more detectors. Writing ones to
                                                     ...
                                                     indicate a glitch detector resets.
...
typedef struct {                                /*!< DMA Structure                                                             */
  ...
  __IOM uint32_t  CH12_AL1_TRANS_COUNT_TRIG;    /*!< Alias for channel 12 TRANS_COUNT register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH12_AL2_WRITE_ADDR_TRIG;     /*!< Alias for channel 12 WRITE_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH12_AL3_READ_ADDR_TRIG;      /*!< Alias for channel 12 READ_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH13_AL1_TRANS_COUNT_TRIG;    /*!< Alias for channel 13 TRANS_COUNT register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH13_AL2_WRITE_ADDR_TRIG;     /*!< Alias for channel 13 WRITE_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH13_AL3_READ_ADDR_TRIG;      /*!< Alias for channel 13 READ_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH14_AL1_TRANS_COUNT_TRIG;    /*!< Alias for channel 14 TRANS_COUNT register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH14_AL2_WRITE_ADDR_TRIG;     /*!< Alias for channel 14 WRITE_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH14_AL3_READ_ADDR_TRIG;      /*!< Alias for channel 14 READ_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH15_AL1_TRANS_COUNT_TRIG;    /*!< Alias for channel 15 TRANS_COUNT register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH15_AL2_WRITE_ADDR_TRIG;     /*!< Alias for channel 15 WRITE_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  CH15_AL3_READ_ADDR_TRIG;      /*!< Alias for channel 15 READ_ADDR register
                                                     This is a trigger register (0xc). Writing a nonzero value
                                                     will
                                                     reload the channel counter and start the channel.                         */
  ...
  __IOM uint32_t  SECCFG_CH0;                   /*!< Security configuration for channel 0. Control whether this channel
                                                     performs Secure/NonSecure and Privileged/Unprivileged bus
                                                     accesses.
                                                     
                                                     If this channel generates bus accesses of some security
                                                     level, an access of at least that level (in the order S+P
                                                     > S+U > NS+P > NS+U) is required to program, trigger, abort,
                                                     check the status of, interrupt on or acknowledge the interrupt
                                                     of this channel.
                                                     
                                                     This register automatically locks down (becomes read-only)
                                                     once software starts to configure the channel.
                                                     
                                                     This register is world-readable, but is writable only from
                                                     a Secure, Privileged context.                                             */
  ...
  __IOM uint32_t  SECCFG_IRQ0;                  /*!< Security configuration for IRQ 0. Control whether the IRQ permits
                                                     configuration by NonSecure/Unprivileged contexts, and whether
  ...
  __IOM uint32_t  MPU_CTRL;                     /*!< Control register for DMA MPU. Accessible only from a Secure,
                                                     Privileged context.                                                       */
  ...
  __IOM uint32_t  CH12_DBG_CTDREQ;              /*!< Read: get channel DREQ counter (i.e. how many accesses the DMA
                                                     ...
                                                     Write any value: clears the counter, and cause channel
                                                     to re-initiate DREQ handshake.                                            */
  __IM  uint32_t  CH12_DBG_TCR;                 /*!< Read to get channel TRANS_COUNT reload value, i.e. the length
                                                     of the next transfer                                                      */
  ...
  __IOM uint32_t  CH13_DBG_CTDREQ;              /*!< Read: get channel DREQ counter (i.e. how many accesses the DMA
                                                     ...
                                                     Write any value: clears the counter, and cause channel
                                                     to re-initiate DREQ handshake.                                            */
  __IM  uint32_t  CH13_DBG_TCR;                 /*!< Read to get channel TRANS_COUNT reload value, i.e. the length
                                                     of the next transfer                                                      */
  ...
  __IOM uint32_t  CH14_DBG_CTDREQ;              /*!< Read: get channel DREQ counter (i.e. how many accesses the DMA
                                                     ...
                                                     Write any value: clears the counter, and cause channel
                                                     to re-initiate DREQ handshake.                                            */
  __IM  uint32_t  CH14_DBG_TCR;                 /*!< Read to get channel TRANS_COUNT reload value, i.e. the length
                                                     of the next transfer                                                      */
  ...
  __IOM uint32_t  CH15_DBG_CTDREQ;              /*!< Read: get channel DREQ counter (i.e. how many accesses the DMA
                                                     ...
                                                     Write any value: clears the counter, and cause channel
                                                     to re-initiate DREQ handshake.                                            */
  __IM  uint32_t  CH15_DBG_TCR;                 /*!< Read to get channel TRANS_COUNT reload value, i.e. the length
                                                     of the next transfer                                                      */
...
} USBCTRL_REGS_Type;                            /*!< Size = 280 (0x118)                                                        */
...
typedef struct {                                /*!< PIO0 Structure                                                            */
  ...
  __IOM uint32_t  IRQ;                          /*!< State machine IRQ flags register. Write 1 to clear. There are
                                                     ...
                                                     Any combination of the eight flags can also routed out
                                                     to either of the two system-level interrupt requests, alongside
                                                     FIFO status interrupts -- see e.g. IRQ0_INTE.                             */
...
typedef struct {                                /*!< XIP_AUX Structure                                                         */
  __IM  uint32_t  STREAM;                       /*!< Read the XIP stream FIFO (fast bus access to XIP_CTRL_STREAM_FIFO)        */
...
typedef struct {                                /*!< HSTX_FIFO Structure                                                       */
  ...
  __OM  uint32_t  FIFO;                         /*!< Write access to FIFO                                                      */
...
typedef struct {                                /*!< CORESIGHT_TRACE Structure                                                 */
  __IOM uint32_t  CTRL_STATUS;                  /*!< miscellaneous control/status bits                                         */
  __IOM uint32_t  TRACE_CAPTURE_FIFO;           /*!< trace capture fifo                                                        */
...
typedef struct {                                /*!< SIO Structure                                                             */
  ...
  __IM  uint32_t  GPIO_IN;                      /*!< Input value for GPIO0...31.
                                                     
                                                     In the NonSecure SIO, Secure-only GPIOs (as per ACCESSCTRL)
                                                     appear as zero.                                                           */
  __IOM uint32_t  GPIO_HI_IN;                   /*!< Input value on GPIO32...47, QSPI IOs and USB pins
                                                     
                                                     In the NonSecure SIO, Secure-only GPIOs (as per ACCESSCTRL)
                                                     appear as zero.                                                           */
  __IM  uint32_t  RESERVED;
  __IOM uint32_t  GPIO_OUT;                     /*!< GPIO0...31 output value
                                                     Set output level (1/0 -> high/low) for GPIO0...31. Reading
  ...
  __IOM uint32_t  GPIO_HI_OUT;                  /*!< Output value for GPIO32...47, QSPI IOs and USB pins.
                                                     
                                                     Write to set output level (1/0 -> high/low). Reading back
                                                     gives the last value written, NOT the input value from
                                                     the pins. If core 0 and core 1 both write to GPIO_HI_OUT
  ...
  __IOM uint32_t  GPIO_OUT_SET;                 /*!< GPIO0...31 output value set
                                                     ...
                                                     wdata`                                                                    */
  __IOM uint32_t  GPIO_HI_OUT_SET;              /*!< Output value set for GPIO32..47, QSPI IOs and USB pins.
  ...
  __IOM uint32_t  GPIO_OUT_CLR;                 /*!< GPIO0...31 output value clear
                                                     ...
                                                     &= ~wdata`                                                                */
  __IOM uint32_t  GPIO_HI_OUT_CLR;              /*!< Output value clear for GPIO32..47, QSPI IOs and USB pins.
  ...
  __IOM uint32_t  GPIO_OUT_XOR;                 /*!< GPIO0...31 output value XOR
                                                     ...
                                                     ^= wdata`                                                                 */
  __IOM uint32_t  GPIO_HI_OUT_XOR;              /*!< Output value XOR for GPIO32..47, QSPI IOs and USB pins.
  ...
  __IOM uint32_t  GPIO_OE_SET;                  /*!< GPIO0...31 output enable set
                                                     Perform an atomic bit-set on GPIO_OE, i.e. `GPIO_OE |=
                                                     wdata`                                                                    */
  __IOM uint32_t  GPIO_HI_OE_SET;               /*!< Output enable set for GPIO32...47, QSPI IOs and USB pins.
  ...
  __IOM uint32_t  GPIO_OE_XOR;                  /*!< GPIO0...31 output enable XOR
                                                     ...
                                                     ^= wdata`                                                                 */
  __IOM uint32_t  GPIO_HI_OE_XOR;               /*!< Output enable XOR for GPIO32...47, QSPI IOs and USB pins.
  ...
  __OM  uint32_t  INTERP1_BASE_1AND0;           /*!< On write, the lower 16 bits go to BASE0, upper bits to BASE1
                                                     ...
                                                     Each half is sign-extended to 32 bits if that lane's SIGNED
                                                     flag is set.                                                              */
  __IM  uint32_t  SPINLOCK0;                    /*!< Reading from a spinlock address will:
  ...
  __IM  uint32_t  SPINLOCK1;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK2;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK3;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK4;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK5;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK6;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK7;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK8;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK9;                    /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK10;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK11;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK12;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK13;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK14;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK15;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK16;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK17;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK18;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK19;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK20;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK21;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK22;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK23;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK24;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK25;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK26;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK27;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK28;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK29;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK30;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IM  uint32_t  SPINLOCK31;                   /*!< Reading from a spinlock address will:
                                                     - Return 0 if lock is already locked
                                                     - Otherwise return nonzero, and simultaneously claim the
                                                     lock
                                                     ...
                                                     core 0 wins.
                                                     The value returned on success is 0x1 << lock number.                      */
  __IOM uint32_t  DOORBELL_OUT_SET;             /*!< Trigger a doorbell interrupt on the opposite core.
                                                     
                                                     Write 1 to a bit to set the corresponding bit in DOORBELL_IN
                                                     on the opposite core. This raises the opposite core's doorbell
                                                     interrupt.
  ...
  __IOM uint32_t  DOORBELL_OUT_CLR;             /*!< Clear doorbells which have been posted to the opposite core.
                                                     ...
                                                     bit in DOORBELL_IN on the opposite core. Clearing all bits
                                                     will cause that core's doorbell interrupt to deassert.
                                                     Since the usual order of events is for software to send
                                                     events using DOORBELL_OUT_SET, and acknowledge incoming
                                                     events by writing to DOORBELL_IN_CLR, this register should
                                                     be used with caution to avoid race conditions.
  ...
  __IOM uint32_t  DOORBELL_IN_CLR;              /*!< Check and acknowledge doorbells posted to this core. This core's
                                                     ...
                                                     deasserts once all bits are cleared. Read to get status
  ...
  __IOM uint32_t  PERI_NONSEC;                  /*!< Detach certain core-local peripherals from Secure SIO, and attach
                                                     them to NonSecure SIO, so that NonSecure software can use
                                                     them. Attempting to access one of these peripherals from
                                                     the Secure SIO when it is attached to the NonSecure SIO,
                                                     or vice versa, will generate a bus error.
  ...
  __IOM uint32_t  RISCV_SOFTIRQ;                /*!< Control the assertion of the standard software interrupt (MIP.MSIP)
                                                     ...
                                                     Unlike the RISC-V timer, this interrupt is not routed to
                                                     a normal system-level interrupt line, so can not be used
                                                     by the Arm cores.
                                                     
                                                     It is safe for both cores to write to this register on
                                                     the same cycle. The set/clear effect is accumulated across
                                                     both cores, and then applied. If a flag is both set and
                                                     cleared on the same cycle, only the set takes effect.                     */
  __IOM uint32_t  MTIME_CTRL;                   /*!< Control register for the RISC-V 64-bit Machine-mode timer. This
                                                     ...
                                                     it is equally usable by the Arm cores. The interrupts are
                                                     routed to normal system-level interrupt lines as well as
                                                     to the MIP.MTIP inputs on the RISC-V cores.                               */
  ...
  __IOM uint32_t  MTIMECMP;                     /*!< Low half of RISC-V Machine-mode timer comparator. This register
                                                     ...
                                                     The timer interrupt is asserted whenever MTIME is greater
  ...
  __OM  uint32_t  TMDS_WDATA;                   /*!< Write-only access to the TMDS colour data register.                       */
  __IM  uint32_t  TMDS_PEEK_SINGLE;             /*!< Get the encoding of one pixel's worth of colour data, packed
                                                     into a 32-bit value (3x10-bit symbols).
                                                     
                                                     The PEEK alias does not shift the colour register when
                                                     read, but still advances the running DC balance state of
                                                     each encoder. This is useful for pixel doubling.                          */
  __IM  uint32_t  TMDS_POP_SINGLE;              /*!< Get the encoding of one pixel's worth of colour data, packed
                                                     ...
                                                     shifting out with the HSTX peripheral on RP2350.
                                                     
                                                     The POP alias shifts the colour register when read, as
                                                     well as advancing the running DC balance state of each
                                                     encoder.                                                                  */
  __IM  uint32_t  TMDS_PEEK_DOUBLE_L0;          /*!< Get lane 0 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
                                                     
                                                     The PEEK alias does not shift the colour register when
                                                     read, but still advances the lane 0 DC balance state. This
                                                     is useful if all 3 lanes' worth of encode are to be read
                                                     at once, rather than processing the entire scanline for
                                                     one lane before moving to the next lane.                                  */
  __IM  uint32_t  TMDS_POP_DOUBLE_L0;           /*!< Get lane 0 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
                                                     
                                                     The POP alias shifts the colour register when read, according
                                                     to the values of PIX_SHIFT and PIX2_NOSHIFT.                              */
  __IM  uint32_t  TMDS_PEEK_DOUBLE_L1;          /*!< Get lane 1 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
                                                     
                                                     The PEEK alias does not shift the colour register when
                                                     read, but still advances the lane 1 DC balance state. This
                                                     is useful if all 3 lanes' worth of encode are to be read
                                                     at once, rather than processing the entire scanline for
                                                     one lane before moving to the next lane.                                  */
  __IM  uint32_t  TMDS_POP_DOUBLE_L1;           /*!< Get lane 1 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
                                                     
                                                     The POP alias shifts the colour register when read, according
                                                     to the values of PIX_SHIFT and PIX2_NOSHIFT.                              */
  __IM  uint32_t  TMDS_PEEK_DOUBLE_L2;          /*!< Get lane 2 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
                                                     
                                                     The PEEK alias does not shift the colour register when
                                                     read, but still advances the lane 2 DC balance state. This
                                                     is useful if all 3 lanes' worth of encode are to be read
                                                     at once, rather than processing the entire scanline for
                                                     one lane before moving to the next lane.                                  */
  __IM  uint32_t  TMDS_POP_DOUBLE_L2;           /*!< Get lane 2 of the encoding of two pixels' worth of colour data.
                                                     Two 10-bit TMDS symbols are packed at the bottom of a 32-bit
                                                     word.
...
typedef struct {                                /*!< PPB Structure                                                             */
  ...
  __IOM uint32_t  CFSR;                         /*!< Contains the three Configurable Fault Status Registers.
  ...
  __IOM uint32_t  TRCITATBIDR;                  /*!< Trace Intergration ATB Identification Register                            */
  ...
  __IOM uint32_t  PIDR4;                        /*!< CoreSight Periperal ID4                                                   */
  __IOM uint32_t  PIDR5;                        /*!< CoreSight Periperal ID5                                                   */
  __IOM uint32_t  PIDR6;                        /*!< CoreSight Periperal ID6                                                   */
  __IOM uint32_t  PIDR7;                        /*!< CoreSight Periperal ID7                                                   */
  __IOM uint32_t  PIDR0;                        /*!< CoreSight Periperal ID0                                                   */
  __IOM uint32_t  PIDR1;                        /*!< CoreSight Periperal ID1                                                   */
  __IOM uint32_t  PIDR2;                        /*!< CoreSight Periperal ID2                                                   */
  __IOM uint32_t  PIDR3;                        /*!< CoreSight Periperal ID3                                                   */
...
#define RISCV_CSR_BASE_FIXME        ((RISCV_CSR_BASE_FIXME_Type*)  RISCV_CSR_BASE_FIXME_BASE)
...
#define ACCESSCTRL_APBS             ((ACCESSCTRL_APBS_Type*)   ACCESSCTRL_APBS_BASE)
...
#define XIP_QMI                     ((XIP_QMI_Type*)           XIP_QMI_BASE)
...
#define RISCV_DM_DUMMY_ADDRESS_FIXME ((RISCV_DM_DUMMY_ADDRESS_FIXME_Type*)  RISCV_DM_DUMMY_ADDRESS_FIXME_BASE)
