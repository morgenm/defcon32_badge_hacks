...
// =============================================================================
#ifndef HARDWARE_REGS_SHA256_DEFINED
#define HARDWARE_REGS_SHA256_DEFINED
// =============================================================================
// Register    : SHA256_CSR
...
//               of data (either a word write, two halfword writes in
//               little-endian order, or four byte writes in little-endian
//               order) the final value can be byte-swapped before passing to
//               the actual SHA core.
//
...
// =============================================================================
#endif // HARDWARE_REGS_SHA256_DEFINED
