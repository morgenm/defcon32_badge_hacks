...
// Version        : 1
// Bus type       : apb
// Description    : RISC-V Debug module registers (Hazard3 subset only).
//                  Read-only information fields (such as dmstatus.version) are
//                  listed here with the values they have on the RP2350
//                  instantiation of Hazard3.
// =============================================================================
#ifndef HARDWARE_REGS_RISCV_DM_DEFINED
#define HARDWARE_REGS_RISCV_DM_DEFINED
// =============================================================================
...
// Description : If 1, then there is an implicit ebreak instruction at the
//               non-existent word immediately after the Program Buffer. This
//               saves the debugger from having to write the ebreak itself, and
...
//               they are cleared by writing 1 to them. While this field is
//               non-zero, no more system bus accesses can be initiated by the
//               Debug Module.
//
...
// =============================================================================
#endif // HARDWARE_REGS_RISCV_DM_DEFINED
