...
// =============================================================================
#ifndef HARDWARE_REGS_ACCESSCTRL_DEFINED
#define HARDWARE_REGS_ACCESSCTRL_DEFINED
// =============================================================================
...
// Description : Force core 1's bus accesses to always be NonSecure, no matter
//               the core's internal state.
//
//               Useful for schemes where one core is designated as the
//               NonSecure core, since some peripherals may filter individual
...
// Description : Control whether GPIO0...31 are accessible to NonSecure code.
...
// Description : Control whether GPIO32..47 are accessible to NonSecure code,
//               and whether QSPI and USB bitbang are accessible through the
//               NonSecure SIO. Writable only by a Secure, Privileged processor
//               or debugger.
...
//               becomes NonSecure-Privileged-writable when the NSP bit is set.
...
// Description : If 1, ROM can be accessed from a NonSecure, Privileged context.
...
// Description : If 1, and NSP is also set, ROM can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
...
// Description : If 1, XIP_MAIN can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, XIP_MAIN can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM2 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM2 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM3 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM3 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM4 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM4 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM5 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM5 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM6 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM6 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM7 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM7 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM8 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM8 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SRAM9 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SRAM9 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, DMA can be accessed from a NonSecure, Privileged context.
...
// Description : If 1, and NSP is also set, DMA can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, USBCTRL can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, USBCTRL can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PIO0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, PIO0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PIO1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, PIO1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PIO2 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, PIO2 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, CORESIGHT_TRACE can be accessed from a NonSecure,
//               Privileged context.
...
//               a NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, CORESIGHT_PERIPH can be accessed from a NonSecure,
//               Privileged context.
...
//               from a NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SYSINFO can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SYSINFO can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, RESETS can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, RESETS can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, IO_BANK0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, IO_BANK0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, IO_BANK1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, IO_BANK1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PADS_BANK0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, PADS_QSPI can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, BUSCTRL can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, BUSCTRL can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, ADC0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, ADC0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, HSTX can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, HSTX can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, I2C0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, I2C0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, I2C1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, I2C1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PWM can be accessed from a NonSecure, Privileged context.
...
// Description : If 1, and NSP is also set, PWM can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SPI0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SPI0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SPI1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SPI1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, TIMER0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, TIMER0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, TIMER1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, TIMER1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, UART0 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, UART0 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, UART1 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, UART1 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, OTP can be accessed from a NonSecure, Privileged context.
...
// Description : If 1, and NSP is also set, OTP can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, TBMAN can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, TBMAN can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, POWMAN can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, POWMAN can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, TRNG can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, TRNG can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SHA256 can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SHA256 can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, SYSCFG can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, SYSCFG can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// =============================================================================
// Register    : ACCESSCTRL_CLOCKS_BANK_DEFAULT
// Description : Control whether debugger, DMA, core 0 and core 1 can access
//               CLOCKS_BANK_DEFAULT, and at what security/privilege levels they
//               can do so.
//
//               Defaults to Secure, Privileged processor or debug access only.
//
...
//               processor or debugger, with the exception of the NSU bit, which
//               becomes NonSecure-Privileged-writable when the NSP bit is set.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_OFFSET _u(0x000000c0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_BITS   _u(0x000000ff)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_RESET  _u(0x000000b8)
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed by the debugger, at
//               security/privilege levels permitted by SP/NSP/SU/NSU in this
//               register.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG_RESET  _u(0x1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG_BITS   _u(0x00000080)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG_MSB    _u(7)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG_LSB    _u(7)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DBG_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed by the DMA, at
//               security/privilege levels permitted by SP/NSP/SU/NSU in this
//               register.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA_RESET  _u(0x0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA_BITS   _u(0x00000040)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA_MSB    _u(6)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA_LSB    _u(6)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_DMA_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed by core 1, at
//               security/privilege levels permitted by SP/NSP/SU/NSU in this
//               register.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1_RESET  _u(0x1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1_BITS   _u(0x00000020)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1_MSB    _u(5)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1_LSB    _u(5)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE1_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed by core 0, at
//               security/privilege levels permitted by SP/NSP/SU/NSU in this
//               register.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0_RESET  _u(0x1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0_BITS   _u(0x00000010)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0_MSB    _u(4)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0_LSB    _u(4)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_CORE0_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed from a Secure,
//               Privileged context.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP_RESET  _u(0x1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP_BITS   _u(0x00000008)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP_MSB    _u(3)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP_LSB    _u(3)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SP_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU
// Description : If 1, and SP is also set, CLOCKS_BANK_DEFAULT can be accessed
//               from a Secure, Unprivileged context.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU_RESET  _u(0x0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU_BITS   _u(0x00000004)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU_MSB    _u(2)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU_LSB    _u(2)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_SU_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP
// Description : If 1, CLOCKS_BANK_DEFAULT can be accessed from a NonSecure,
//               Privileged context.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP_RESET  _u(0x0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP_BITS   _u(0x00000002)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP_MSB    _u(1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP_LSB    _u(1)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSP_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU
// Description : If 1, and NSP is also set, CLOCKS_BANK_DEFAULT can be accessed
//               from a NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU_RESET  _u(0x0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU_BITS   _u(0x00000001)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU_MSB    _u(0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU_LSB    _u(0)
#define ACCESSCTRL_CLOCKS_BANK_DEFAULT_NSU_ACCESS "RW"
// =============================================================================
...
// Description : If 1, XOSC can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, XOSC can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, ROSC can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, ROSC can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PLL_SYS can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, PLL_SYS can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, PLL_USB can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, PLL_USB can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, TICKS can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, TICKS can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, WATCHDOG can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, WATCHDOG can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, RSM can be accessed from a NonSecure, Privileged context.
...
// Description : If 1, and NSP is also set, RSM can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, XIP_CTRL can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, XIP_CTRL can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, XIP_QMI can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, XIP_QMI can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// Description : If 1, XIP_AUX can be accessed from a NonSecure, Privileged
//               context.
...
// Description : If 1, and NSP is also set, XIP_AUX can be accessed from a
//               NonSecure, Unprivileged context.
//
//               This bit is writable from a NonSecure, Privileged context, if
//               and only if the NSP bit is set.
...
// =============================================================================
#endif // HARDWARE_REGS_ACCESSCTRL_DEFINED
