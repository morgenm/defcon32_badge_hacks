...
// =============================================================================
#ifndef HARDWARE_REGS_OTP_DEFINED
#define HARDWARE_REGS_OTP_DEFINED
// =============================================================================
...
// Description : NonSecure lock status. Writes are OR'd with the current value.
//               0x0 -> read_write
//               0x1 -> read_only
//               0x3 -> inaccessible
...
//               This field is read-only to NonSecure code.
//               0x0 -> read_write
//               0x1 -> read_only
//               0x3 -> inaccessible
...
// Description : Instructions to the SBPI interface
...
// Description : Write payload bytes 3..0
...
// Description : Write payload bytes 7..4
...
// Description : Write payload bytes 11..8
...
// Description : Write payload bytes 15..12
...
// -----------------------------------------------------------------------------
// Field       : OTP_USR_PD
// Description : Power-down; HIGH disables current reference
...
// -----------------------------------------------------------------------------
// Field       : OTP_USR_DCTRL
// Description : HIGH enables user interface; LOW disables user interface
//               (enables SBPI)
...
#define OTP_DBG_BITS   _u(0x000011ff)
...
// -----------------------------------------------------------------------------
// Field       : OTP_DBG_CRIT_FAIL
// Description : Failed to read magic word. FIXME: secret?
#define OTP_DBG_CRIT_FAIL_RESET  _u(0x0)
#define OTP_DBG_CRIT_FAIL_BITS   _u(0x00000100)
#define OTP_DBG_CRIT_FAIL_MSB    _u(8)
#define OTP_DBG_CRIT_FAIL_LSB    _u(8)
#define OTP_DBG_CRIT_FAIL_ACCESS "WC"
// -----------------------------------------------------------------------------
...
// =============================================================================
// Register    : OTP_PROD0_CTL
// Description : Controls availale only during production_mode = 0
#define OTP_PROD0_CTL_OFFSET _u(0x00000130)
#define OTP_PROD0_CTL_BITS   _u(0x00000000)
#define OTP_PROD0_CTL_RESET  _u(0x00003000)
// =============================================================================
// Register    : OTP_BIST
...
// Description : Enable the counter before the BIST function is initated
...
//               of this register.
//
//               - If both debug keys have been registered, and the NonSecure
...
// =============================================================================
#endif // HARDWARE_REGS_OTP_DEFINED
