...
//                  bootcode use
// =============================================================================
#ifndef HARDWARE_REGS_POWMAN_DEFINED
#define HARDWARE_REGS_POWMAN_DEFINED
// =============================================================================
...
#define POWMAN_VREG_CTRL_BITS   _u(0x0000b173)
...
// -----------------------------------------------------------------------------
// Field       : POWMAN_VREG_CTRL_LT_TH
// Description : enable
//               0=not enabled, 1=enabled
#define POWMAN_VREG_CTRL_LT_TH_RESET  _u(0x0)
#define POWMAN_VREG_CTRL_LT_TH_BITS   _u(0x00000003)
#define POWMAN_VREG_CTRL_LT_TH_MSB    _u(1)
#define POWMAN_VREG_CTRL_LT_TH_LSB    _u(0)
#define POWMAN_VREG_CTRL_LT_TH_ACCESS "RW"
// =============================================================================
...
#define POWMAN_VREG_BITS   _u(0x000081f6)
...
#define POWMAN_VREG_MODE_RESET  _u(0x0)
#define POWMAN_VREG_MODE_BITS   _u(0x00000004)
#define POWMAN_VREG_MODE_MSB    _u(2)
#define POWMAN_VREG_MODE_LSB    _u(2)
#define POWMAN_VREG_MODE_ACCESS "RW"
// -----------------------------------------------------------------------------
...
// Description : This flag is not reset by RUN. It tells bootcode to go into the
//               bootloader and provides an alternative to the double tap
//               method.
...
//               select CLOCKS or earlier will result in the POWMAN_WATCHDOG
//               register having no effect.
#define POWMAN_WATCHDOG_OFFSET _u(0x00000030)
#define POWMAN_WATCHDOG_BITS   _u(0x00001111)
#define POWMAN_WATCHDOG_RESET  _u(0x00000000)
// -----------------------------------------------------------------------------
// Field       : POWMAN_WATCHDOG_RESET_RSM
// Description : If set to 1, a watchdog reset will run the full reset state
//               machine (RSM) sequence
...
#define POWMAN_WATCHDOG_RESET_RSM_RESET  _u(0x0)
#define POWMAN_WATCHDOG_RESET_RSM_BITS   _u(0x00001000)
#define POWMAN_WATCHDOG_RESET_RSM_MSB    _u(12)
#define POWMAN_WATCHDOG_RESET_RSM_LSB    _u(12)
#define POWMAN_WATCHDOG_RESET_RSM_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : POWMAN_WATCHDOG_RESET_SWCORE
// Description : If set to 1, a watchdog reset will reset the switched core
//               power domain and run the full reset state machine (RSM)
//               sequence
//               From a user perspective it is the same as setting
//               RSM_WDSEL_PROC_COLD
//               From a hardware debug perspective it has the same effect as a
//               power-on reset for the switched core power domain
#define POWMAN_WATCHDOG_RESET_SWCORE_RESET  _u(0x0)
#define POWMAN_WATCHDOG_RESET_SWCORE_BITS   _u(0x00000100)
#define POWMAN_WATCHDOG_RESET_SWCORE_MSB    _u(8)
#define POWMAN_WATCHDOG_RESET_SWCORE_LSB    _u(8)
#define POWMAN_WATCHDOG_RESET_SWCORE_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : POWMAN_WATCHDOG_RESET_POWMAN
...
//               may not be true
#define POWMAN_WATCHDOG_RESET_POWMAN_RESET  _u(0x0)
#define POWMAN_WATCHDOG_RESET_POWMAN_BITS   _u(0x00000010)
#define POWMAN_WATCHDOG_RESET_POWMAN_MSB    _u(4)
#define POWMAN_WATCHDOG_RESET_POWMAN_LSB    _u(4)
#define POWMAN_WATCHDOG_RESET_POWMAN_ACCESS "RW"
// -----------------------------------------------------------------------------
// Field       : POWMAN_WATCHDOG_RESET_POWMAN_ASYNC
// Description : If set to 1, a watchdog reset will restore powman defaults,
//               reset the timer,
//               reset the switched core domain and run the full reset state
//               machine (RSM) sequence
//               This does not rely on clk_ref running
#define POWMAN_WATCHDOG_RESET_POWMAN_ASYNC_RESET  _u(0x0)
#define POWMAN_WATCHDOG_RESET_POWMAN_ASYNC_BITS   _u(0x00000001)
#define POWMAN_WATCHDOG_RESET_POWMAN_ASYNC_MSB    _u(0)
#define POWMAN_WATCHDOG_RESET_POWMAN_ASYNC_LSB    _u(0)
#define POWMAN_WATCHDOG_RESET_POWMAN_ASYNC_ACCESS "RW"
// =============================================================================
...
// Description : Integer component of the LPOSC or GPIO clock source frequency
...
// Description : Integer component of the XOSC frequency in kHz. Default = 12000
...
// Description : Fractional component of the XOSC frequency in kHz. This field
...
// Description : Enables the timer, the timer is not cleared when RUN is
//               deasserted. To run the timer set the POWMAN_LPOSC_FREQ* and/or
//               POWMAN_XOSC_FREQ* registers, then set the time in the
//               POWMAN_TIMER_SEC* & POWMAN_TIMER_MSEC registers, then start the
//               timer by setting POWMAN_TIMER_RUN=1. This will start the timer
//               running from the LPOSC. When the XOSC is available switch the
//               reference clock to XOSC then select it as the timer clock by
//               setting POWMAN_TIMER_USE_XOSC=1
...
// Description : Control whether NonSecure software can write to the timer
...
//
//               This flag should be set by an early boot stage that has
//               soft-locked OTP pages, to prevent later stages from unlocking
//               it by power cycling.
...
// =============================================================================
#endif // HARDWARE_REGS_POWMAN_DEFINED
