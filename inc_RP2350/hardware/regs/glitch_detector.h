...
// =============================================================================
#ifndef HARDWARE_REGS_GLITCH_DETECTOR_DEFINED
#define HARDWARE_REGS_GLITCH_DETECTOR_DEFINED
// =============================================================================
...
//               0x0000 -> Force the glitch detectors to be armed. (Any value
...
//
//               This register is Secure read/write only.
//               0x0000 -> Do not disarm the glitch detectors. (Any value other
...
// Description : 0x00 -> Use the default sensitivity configured in OTP for all
//               detectors. (Any value other than DEFAULT_NO counts as YES)
//               0xde -> Do not use the default sensitivity configured in OTP.
...
// =============================================================================
#endif // HARDWARE_REGS_GLITCH_DETECTOR_DEFINED
