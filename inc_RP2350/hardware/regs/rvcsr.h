...
// =============================================================================
#ifndef HARDWARE_REGS_RVCSR_DEFINED
#define HARDWARE_REGS_RVCSR_DEFINED
// =============================================================================
...
#define RVCSR_MISA_BITS   _u(0xc0901005)
#define RVCSR_MISA_RESET  _u(0x40901005)
// -----------------------------------------------------------------------------
...
//               0x1 -> Vectored entry to a 16-entry jump table starting at
//               mtvec
...
//               exception.
//               0x0 -> Instruction fetch was misaligned. Will never fire on
//               RP2350, since the C extension is enabled.
//               0x1 -> Instruction access fault. Instruction fetch failed a PMP
//               check, or encountered a downstream bus fault, and then passed
//               the point of no speculation.
...
//               0x4 -> Load address misaligned. Hazard3 requires natural
//               alignment of all accesses.
//               0x5 -> Load access fault. A load failed a PMP check, or
//               encountered a downstream bus error.
//               0x6 -> Store/AMO address misaligned. Hazard3 requires natural
//               alignment of all accesses.
//               0x7 -> Store/AMO access fault. A store/AMO failed a PMP check,
//               or encountered a downstream bus error. Also set if an AMO is
...
// -----------------------------------------------------------------------------
// Field       : RVCSR_MIP_MSIE
// Description : Software interrupt pending. The processor transfers to the
//               software interrupt vector `mie.msie`, `mip.msip` and
//               `mstatus.mie` are all 1, unless an external interrupt request
//               is also valid at this time.
#define RVCSR_MIP_MSIE_RESET  _u(0x0)
#define RVCSR_MIP_MSIE_BITS   _u(0x00000008)
#define RVCSR_MIP_MSIE_MSB    _u(3)
#define RVCSR_MIP_MSIE_LSB    _u(3)
#define RVCSR_MIP_MSIE_ACCESS "RW"
// =============================================================================
...
// Description : Execute permission for region 3
#define RVCSR_PMPCFG0_R3_X_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R3_X_BITS   _u(0x04000000)
#define RVCSR_PMPCFG0_R3_X_MSB    _u(26)
#define RVCSR_PMPCFG0_R3_X_LSB    _u(26)
...
// Description : Read permission for region 3
#define RVCSR_PMPCFG0_R3_R_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R3_R_BITS   _u(0x01000000)
#define RVCSR_PMPCFG0_R3_R_MSB    _u(24)
#define RVCSR_PMPCFG0_R3_R_LSB    _u(24)
...
// Description : Execute permission for region 2
#define RVCSR_PMPCFG0_R2_X_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R2_X_BITS   _u(0x00040000)
#define RVCSR_PMPCFG0_R2_X_MSB    _u(18)
#define RVCSR_PMPCFG0_R2_X_LSB    _u(18)
...
// Description : Read permission for region 2
#define RVCSR_PMPCFG0_R2_R_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R2_R_BITS   _u(0x00010000)
#define RVCSR_PMPCFG0_R2_R_MSB    _u(16)
#define RVCSR_PMPCFG0_R2_R_LSB    _u(16)
...
// Description : Execute permission for region 1
#define RVCSR_PMPCFG0_R1_X_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R1_X_BITS   _u(0x00000400)
#define RVCSR_PMPCFG0_R1_X_MSB    _u(10)
#define RVCSR_PMPCFG0_R1_X_LSB    _u(10)
...
// Description : Read permission for region 1
#define RVCSR_PMPCFG0_R1_R_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R1_R_BITS   _u(0x00000100)
#define RVCSR_PMPCFG0_R1_R_MSB    _u(8)
#define RVCSR_PMPCFG0_R1_R_LSB    _u(8)
...
// Description : Execute permission for region 0
#define RVCSR_PMPCFG0_R0_X_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R0_X_BITS   _u(0x00000004)
#define RVCSR_PMPCFG0_R0_X_MSB    _u(2)
#define RVCSR_PMPCFG0_R0_X_LSB    _u(2)
...
// Description : Read permission for region 0
#define RVCSR_PMPCFG0_R0_R_RESET  _u(0x0)
#define RVCSR_PMPCFG0_R0_R_BITS   _u(0x00000001)
#define RVCSR_PMPCFG0_R0_R_MSB    _u(0)
#define RVCSR_PMPCFG0_R0_R_LSB    _u(0)
...
// Description : Execute permission for region 7
#define RVCSR_PMPCFG1_R7_X_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R7_X_BITS   _u(0x04000000)
#define RVCSR_PMPCFG1_R7_X_MSB    _u(26)
#define RVCSR_PMPCFG1_R7_X_LSB    _u(26)
...
// Description : Read permission for region 7
#define RVCSR_PMPCFG1_R7_R_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R7_R_BITS   _u(0x01000000)
#define RVCSR_PMPCFG1_R7_R_MSB    _u(24)
#define RVCSR_PMPCFG1_R7_R_LSB    _u(24)
...
// Description : Execute permission for region 6
#define RVCSR_PMPCFG1_R6_X_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R6_X_BITS   _u(0x00040000)
#define RVCSR_PMPCFG1_R6_X_MSB    _u(18)
#define RVCSR_PMPCFG1_R6_X_LSB    _u(18)
...
// Description : Read permission for region 6
#define RVCSR_PMPCFG1_R6_R_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R6_R_BITS   _u(0x00010000)
#define RVCSR_PMPCFG1_R6_R_MSB    _u(16)
#define RVCSR_PMPCFG1_R6_R_LSB    _u(16)
...
// Description : Execute permission for region 5
#define RVCSR_PMPCFG1_R5_X_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R5_X_BITS   _u(0x00000400)
#define RVCSR_PMPCFG1_R5_X_MSB    _u(10)
#define RVCSR_PMPCFG1_R5_X_LSB    _u(10)
...
// Description : Read permission for region 5
#define RVCSR_PMPCFG1_R5_R_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R5_R_BITS   _u(0x00000100)
#define RVCSR_PMPCFG1_R5_R_MSB    _u(8)
#define RVCSR_PMPCFG1_R5_R_LSB    _u(8)
...
// Description : Execute permission for region 4
#define RVCSR_PMPCFG1_R4_X_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R4_X_BITS   _u(0x00000004)
#define RVCSR_PMPCFG1_R4_X_MSB    _u(2)
#define RVCSR_PMPCFG1_R4_X_LSB    _u(2)
...
// Description : Read permission for region 4
#define RVCSR_PMPCFG1_R4_R_RESET  _u(0x0)
#define RVCSR_PMPCFG1_R4_R_BITS   _u(0x00000001)
#define RVCSR_PMPCFG1_R4_R_MSB    _u(0)
#define RVCSR_PMPCFG1_R4_R_LSB    _u(0)
...
// Description : Execute permission for region 11
#define RVCSR_PMPCFG2_R11_X_RESET  _u(0x0)
#define RVCSR_PMPCFG2_R11_X_BITS   _u(0x04000000)
#define RVCSR_PMPCFG2_R11_X_MSB    _u(26)
#define RVCSR_PMPCFG2_R11_X_LSB    _u(26)
...
// Description : Read permission for region 11
#define RVCSR_PMPCFG2_R11_R_RESET  _u(0x0)
#define RVCSR_PMPCFG2_R11_R_BITS   _u(0x01000000)
#define RVCSR_PMPCFG2_R11_R_MSB    _u(24)
#define RVCSR_PMPCFG2_R11_R_LSB    _u(24)
...
// Description : Execute permission for region 10
#define RVCSR_PMPCFG2_R10_X_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R10_X_BITS   _u(0x00040000)
#define RVCSR_PMPCFG2_R10_X_MSB    _u(18)
#define RVCSR_PMPCFG2_R10_X_LSB    _u(18)
...
// Description : Read permission for region 10
#define RVCSR_PMPCFG2_R10_R_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R10_R_BITS   _u(0x00010000)
#define RVCSR_PMPCFG2_R10_R_MSB    _u(16)
#define RVCSR_PMPCFG2_R10_R_LSB    _u(16)
...
// Description : Execute permission for region 9
#define RVCSR_PMPCFG2_R9_X_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R9_X_BITS   _u(0x00000400)
#define RVCSR_PMPCFG2_R9_X_MSB    _u(10)
#define RVCSR_PMPCFG2_R9_X_LSB    _u(10)
...
// Description : Read permission for region 9
#define RVCSR_PMPCFG2_R9_R_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R9_R_BITS   _u(0x00000100)
#define RVCSR_PMPCFG2_R9_R_MSB    _u(8)
#define RVCSR_PMPCFG2_R9_R_LSB    _u(8)
...
// Description : Execute permission for region 8
#define RVCSR_PMPCFG2_R8_X_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R8_X_BITS   _u(0x00000004)
#define RVCSR_PMPCFG2_R8_X_MSB    _u(2)
#define RVCSR_PMPCFG2_R8_X_LSB    _u(2)
...
// Description : Read permission for region 8
#define RVCSR_PMPCFG2_R8_R_RESET  _u(0x1)
#define RVCSR_PMPCFG2_R8_R_BITS   _u(0x00000001)
#define RVCSR_PMPCFG2_R8_R_MSB    _u(0)
#define RVCSR_PMPCFG2_R8_R_LSB    _u(0)
...
// Description : Execute permission for region 15
#define RVCSR_PMPCFG3_R15_X_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R15_X_BITS   _u(0x04000000)
#define RVCSR_PMPCFG3_R15_X_MSB    _u(26)
#define RVCSR_PMPCFG3_R15_X_LSB    _u(26)
...
// Description : Read permission for region 15
#define RVCSR_PMPCFG3_R15_R_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R15_R_BITS   _u(0x01000000)
#define RVCSR_PMPCFG3_R15_R_MSB    _u(24)
#define RVCSR_PMPCFG3_R15_R_LSB    _u(24)
...
// Description : Execute permission for region 14
#define RVCSR_PMPCFG3_R14_X_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R14_X_BITS   _u(0x00040000)
#define RVCSR_PMPCFG3_R14_X_MSB    _u(18)
#define RVCSR_PMPCFG3_R14_X_LSB    _u(18)
...
// Description : Read permission for region 14
#define RVCSR_PMPCFG3_R14_R_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R14_R_BITS   _u(0x00010000)
#define RVCSR_PMPCFG3_R14_R_MSB    _u(16)
#define RVCSR_PMPCFG3_R14_R_LSB    _u(16)
...
// Description : Execute permission for region 13
#define RVCSR_PMPCFG3_R13_X_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R13_X_BITS   _u(0x00000400)
#define RVCSR_PMPCFG3_R13_X_MSB    _u(10)
#define RVCSR_PMPCFG3_R13_X_LSB    _u(10)
...
// Description : Read permission for region 13
#define RVCSR_PMPCFG3_R13_R_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R13_R_BITS   _u(0x00000100)
#define RVCSR_PMPCFG3_R13_R_MSB    _u(8)
#define RVCSR_PMPCFG3_R13_R_LSB    _u(8)
...
// Description : Execute permission for region 12
#define RVCSR_PMPCFG3_R12_X_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R12_X_BITS   _u(0x00000004)
#define RVCSR_PMPCFG3_R12_X_MSB    _u(2)
#define RVCSR_PMPCFG3_R12_X_LSB    _u(2)
...
// Description : Read permission for region 12
#define RVCSR_PMPCFG3_R12_R_RESET  _u(0x0)
#define RVCSR_PMPCFG3_R12_R_BITS   _u(0x00000001)
#define RVCSR_PMPCFG3_R12_R_MSB    _u(0)
#define RVCSR_PMPCFG3_R12_R_LSB    _u(0)
...
//               0x0 -> Raise a breakpoint exception, which can be handled by
...
// Description : Hardwired to 0: no interrupts are taken during hardware
//               single-stepping.
...
//               0x3 -> Processor entered Debug Mode due to a halt request, or a
//               reset-halt request present when the core reset was released.
//               0x4 -> Processor entered Debug Mode after executing one
//               instruction with single-stepping enabled.
...
//               interrupt. The more useful case here is to schedule some
//               lower-priority handler from within a high-priority interrupt,
//               so that it will execute before the core returns to the
//               foreground code. Implementers may wish to reserve some external
...
//               which is both asserted in `meipa` and enabled in `meiea`,
//               left-shifted by 2 so that it can be used to index an array of
//               32-bit function pointers. If there is no such interrupt, the
//               MSB is set.
//
...
//               and `ppreempt` can be correctly saved/restored across arbitary
...
// =============================================================================
#endif // HARDWARE_REGS_RVCSR_DEFINED
