...
// Description : Integer part of clock divisor, 0 -> max+1, can be changed
//               on-the-fly
...
#define CLOCKS_WAKE_EN0_CLK_ADC_ADC_BITS   _u(0x00000004)
#define CLOCKS_WAKE_EN0_CLK_ADC_ADC_MSB    _u(2)
#define CLOCKS_WAKE_EN0_CLK_ADC_ADC_LSB    _u(2)
...
#define CLOCKS_SLEEP_EN0_CLK_ADC_ADC_BITS   _u(0x00000004)
#define CLOCKS_SLEEP_EN0_CLK_ADC_ADC_MSB    _u(2)
#define CLOCKS_SLEEP_EN0_CLK_ADC_ADC_LSB    _u(2)
...
#define CLOCKS_ENABLED0_CLK_ADC_ADC_BITS   _u(0x00000004)
#define CLOCKS_ENABLED0_CLK_ADC_ADC_MSB    _u(2)
#define CLOCKS_ENABLED0_CLK_ADC_ADC_LSB    _u(2)
