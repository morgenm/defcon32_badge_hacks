...
// =============================================================================
// Register    : SYSCFG_SPARE
// Description : Spare registers, Just in case.
#define SYSCFG_SPARE_OFFSET _u(0x00000014)
#define SYSCFG_SPARE_BITS   _u(0x000000ff)
#define SYSCFG_SPARE_RESET  _u(0x00000000)
#define SYSCFG_SPARE_MSB    _u(7)
#define SYSCFG_SPARE_LSB    _u(0)
#define SYSCFG_SPARE_ACCESS "RW"
// =============================================================================
