...
// =============================================================================
#ifndef HARDWARE_REGS_M33_DEFINED
#define HARDWARE_REGS_M33_DEFINED
// =============================================================================
...
//               is executed, see DWT_CPICNT. - An exception-entry or
//               exception-exit related operation is in progress. - Either
...
//               is executed, see DWT_CPICNT. - No exception-entry or
//               exception-exit operation is in progress, see DWT_EXCCNT. - A
//               load-store operation is in progress. - Either
//               SecureNoninvasiveDebugAllowed() == TRUE, or NS-Req for the
//               operation is set to Non-secure and NoninvasiveDebugAllowed() ==
//               TRUE.
...
//               SecureNoninvasiveDebugAllowed() == TRUE, or the PE is in
//               Non-secure state and NoninvasiveDebugAllowed() == TRUE. The
//               counter is incremented by the number of instructions executed,
//               minus one
...
//               See
//               https://developer.arm.com/documentation/100235/0004/the-cortex-
//               m33-peripherals/system-control-block/application-interrupt-and-
//               reset-control-register?lang=en
...
// Description : Resturn stack enable
...
// =============================================================================
#endif // HARDWARE_REGS_M33_DEFINED
