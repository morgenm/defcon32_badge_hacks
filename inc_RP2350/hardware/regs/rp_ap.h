...
// Description    : None
// =============================================================================
#ifndef HARDWARE_REGS_RP_AP_DEFINED
#define HARDWARE_REGS_RP_AP_DEFINED
// =============================================================================
// Register    : RP_AP_CTRL
...
// Description : Indicates the source of the power manager clock. On
//               switched-core power up the clock switches from the LPOSC to
//               clk_ref and this flag will be set. clk_ref will be running from
//               the ROSC initially but will switch to XOSC when it comes
//               available. On switched-core power down the clock switches to
//               LPOSC and this flag will be cleared.
...
//               the RTC clock to update. On switched-core power-up there is
//               nothing to be done. The RTC continues to run from the LPOSC so
//               this flag will not be set. Software decides whether to switch
//               the RTC clock to XOSC (via clk_ref). On switched-core
//               power-down the sequencer will switch the clock back to LPOSC if
//               software switched it to XOSC. During the switchover the
//               WAITING_TIMCK flag will be set. If the switched-core power down
//               sequence stalls with this flag active then the only recourse is
//               to reset the chip and change software to not select XOSC as the
//               RTC clock source.
...
// =============================================================================
#endif // HARDWARE_REGS_RP_AP_DEFINED
