...
//               indicated by CHAIN_TO. Disable by setting CHAIN_TO = _(this
//               channel)_.
//               Reset value is equal to channel number (12).
...
//               indicated by CHAIN_TO. Disable by setting CHAIN_TO = _(this
//               channel)_.
//               Reset value is equal to channel number (13).
...
//               indicated by CHAIN_TO. Disable by setting CHAIN_TO = _(this
//               channel)_.
//               Reset value is equal to channel number (14).
...
//               indicated by CHAIN_TO. Disable by setting CHAIN_TO = _(this
//               channel)_.
//               Reset value is equal to channel number (15).
...
//               channel performs Secure/NonSecure and Privileged/Unprivileged
//               bus accesses.
//
...
//               accesses. If 0, it performs NonSecure bus accesses.
//
...
//               context of the same Secure/NonSecure level, or any context of a
//               higher Secure/NonSecure level.
...
//               permits configuration by NonSecure/Unprivileged contexts, and
...
//
//               If 0, this IRQ's control registers can be accessed from a
//               NonSecure context, but Secure channels (as per SECCFG_CHx) are
...
//               NonSecure context, but can not see data transfers of Secure
//               channels.
...
//               NonSecure-Privileged reads can see the region's base address
//               and limit address. Set this bit to make the addresses appear as
//               0 to NonSecure reads, even when the region is NonSecure, to
//               avoid leaking information about the processor SAU map.
...
//               region is Secure (1) or NonSecure (0)
...
// Description : Determines the Secure/NonSecure (=1/0) status of addresses
